    ...
    <div className="au-root">
      ...
      <div className="au-layout">
        {menuOpen && windowWidth < 1024 && (
          <div className="au-mobile-overlay" onClick={() => setMenuOpen(false)} />
        )}
        ...
        <main className="au-main">
          <div className="au-topbar">
            <div className="au-topbar-left">
              <button className="au-btn au-btn-white au-btn-icon" onClick={() => setMenuOpen(!menuOpen)}>
                {menuOpen ? (
